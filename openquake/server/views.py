...
@cross_domain_ajax
@require_http_methods(['GET'])
def get_loss_curves(request, job_id, kind, spec):
    """
    ...
    :param kind:
        the kind of curve to download (mean, quantile, stats or rlzs)
    :param spec:
        Which curves to download (sid-<number> or ref-<assets>)
    :returns:
