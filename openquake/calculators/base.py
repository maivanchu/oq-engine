...
class HazardCalculator(BaseCalculator):
    ...
    def basic_pre_execute(self):
        ...
        if 'source' in oq.inputs:
            ...
            if oq.calculation_mode != 'classical_tiling':
    ...
    def read_filter_csm(self):
        ...
        if self.is_stochastic:
            ...
            csm.init_serials()
        if self.oqparam.calculation_mode != 'classical_tiling':
            with self.monitor('filtering composite src model', autoflush=True):
